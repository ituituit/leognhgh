package com.example.weiyunnews.util;
...
public class DBHelper {
	public static final String DB_NAME = "IT_CAST.db";
	...
	private static class SqlLiteHelper extends SQLiteOpenHelper{
		...
		public void onCreate(SQLiteDatabase db) {
			...
			/*
			 * Add By LinKang Begin
			 */
			db.execSQL("CREATE TABLE SHOPPING_CART(ID INTEGER PRIMARY KEY AUTOINCREMENT, PRODUCT_ID INTEGER, PRODUCT_NUM INTEGER)") ;
			
			db.execSQL("CREATE TABLE INVOICE_INFO(ID INTEGER PRIMARY KEY AUTOINCREMENT, INVOICE_ID INTEGER, INVOICE_TITLE TEXT, INVOICE_CONTENT TEXT)") ;
