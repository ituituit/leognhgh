...
public final class Vector3f implements Cloneable, java.io.Serializable {
	...
	public static float[] calculateDistance(Point point, Point linea,
			Point lineb) {
		return calculateDistance(new Vector3f(linea.x, linea.y, 0),
				new Vector3f(lineb.x, lineb.y, 0), new Vector3f(point.x,
						point.y, 0));
	}
	...
	private static float[] calculateDistance(Vector3f A, Vector3f B, Vector3f C) {
		...
		float length = abDir.dot(cb); // cb��ab��������
		Vector3f result = abDir.mult(length).add(B); // ��������������
...
// private Vector3f C = new Vector3f(3f, 3, 0); //����������
//
// public NearestPoint() {
// }
//
